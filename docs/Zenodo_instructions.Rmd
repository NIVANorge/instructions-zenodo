...
| | |
| :------- | :----------- |
2. Search for the community you are looking for **on the _Communities_ search field** and press enter (note that you will not find the community by using the general search field).| ![](Images/search_community.png)|

| | |
| :------- | :----------- |
3. Click on the community's title.| ![](Images/search_community_result.png){width=500px}|
...
- Search for the community and click on _Select_.| ![](images/upload_select_community.png)
...
- It is also possible to add records to communities after upload. Click on the record, find _Communities_ on the sidebar on the right, and click on the wheel icon -> _Submit to Community_. |![](Images/upload_send_to_community.png)|
